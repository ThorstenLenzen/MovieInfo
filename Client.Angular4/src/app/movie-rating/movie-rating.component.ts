...
@Component({
  selector: 'toto-movie-rating',
  templateUrl: './movie-rating.component.html',
  styleUrls: ['./movie-rating.component.less'],
  providers: [
        { provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => MovieRatingComponent), multi: true },
        { provide: NG_VALIDATORS, useExisting: forwardRef(() => MovieRatingComponent), multi: true },
    ],
})
export class MovieRatingComponent implements OnInit, ControlValueAccessor, Validator {
